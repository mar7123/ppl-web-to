...
const CardThird = () => {
  return (
    <Card sx={{ backgroundColor: '#1D9BF0' }}>
      <CardContent
        sx={{
          display: 'flex',
          textAlign: 'center',
      ...
      >
        <Icon icon='tabler:bulb' fontSize='5rem' color='white' />
        <Typography variant='h4' sx={{ mb: 2.75, color: 'common.white' }}>
          Lorem Ipsum
        </Typography>
        <Typography variant='h5' sx={{ mb: 6, color: 'text.secondary', mr: 20, ml: 20, color: 'common.white', maxWidth:'75%' }}>
